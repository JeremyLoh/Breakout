# breakout-2: Bounce update

Adds a ball to the play state of the game. It initially starts at the center of the screen and moves in a random direction upwards. aabb collision has been implemented for the paddle and the ball.
